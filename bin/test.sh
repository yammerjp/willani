...
assert 3    'int add(int a,int b); int main(){return add(1,2);}'
assert 21   'int sum(int, int, int, int, int, int); int main(){return sum(1,2,3,4,5,6);}'
assert 8    'int sub(int i,int j){return i-j;} int main(){return sub(10,2);}'
assert 18   'int calc(int i, int); int main(){return calc(10,2);}int calc(int i,int j){int k; k =10;return i-j+k;}'
assert 4    'int main(){int i;i=0; while(i<4){ i = i +2; }return i;} '
assert 55   'int f(int n){if(n<=1)return n;return n+f(n-1);} int main(){return f(10);}'
...
assert 3    'int main() { int a = 0; for (int i = 0; i<3; i = i + 1) { a = a + 1; } return a; }'
assert 3    'int main() { int i = 0; for (;;) { if (i<3) i = i + 1; else return i; } }'
